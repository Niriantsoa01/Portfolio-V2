    ...
    <>
      <footer className="pt-10 bg-gray-900 text-gray-300">
        <div className="max-w-screen-xl mx-auto px-4 md:px-8">
          <div className="justify-center items-center gap-12 md:flex"></div>
          <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
            <p className="text-gray-300 font-bold text-center sm:text-left text-1xl">
              © Niriantsoa 2024
            </p>
            <p className="text-gray-400 text-center font-semibold sm:text-left text-sm mt-2 sm:mt-0">
              Developpé par Niriantsoa
            </p>
            <div className="flex items-center justify-center gap-x-6 text-gray-400 mt-6">
              <a href="https://www.facebook.com/profile.php?id=100068077281143">
                <svg
              ...
              <a href="https://www.linkedin.com/in/niriantsoa-hergé-andrianomenjanahary-539860273">
                <svg
                  className="w-6 h-6 hover:text-gray-500 duration-150"
                  fill="none"
                  viewBox="0 0 48 48"
                ...
                >
                  <g clipPath="url(#clip0)">
                    <path
                      fill="currentColor"
                      d="M42 4H6a2 2 0 00-2 2v36a2 2 0 002 2h36a2 2 0 002-2V6a2 2 0 00-2-2zM15.8 38H10.6V19.3h5.2V38zm-2.6-21.1c-1.7 0-2.9-1.2-2.9-2.7 0-1.6 1.2-2.8 2.9-2.8s2.9 1.2 2.9 2.8c0 1.5-1.2 2.7-2.9 2.7zM39 38h-5.2v-9.7c0-2.5-.9-4.2-3.2-4.2-1.7 0-2.6 1.1-3 2.2-.2.4-.2 1-.2 1.5V38h-5.2s.1-17.6 0-19.7h5.2v2.8c.7-1 2-2.5 4.9-2.5 3.6 0 6.3 2.3 6.3 7.2V38z"
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0">
              ...
              <a href="https://github.com/Niriantsoa01">
                <svg
                  className="w-6 h-6 hover:text-gray-500 duration-150"
                  fill="none"
                  viewBox="0 0 48 48"
              ...
              <a href="https://www.instagram.com/niriantsoaherge?igsh=ZW9pc3YycGNlemRu">
                <svg
                  className="w-6 h-6 hover:text-gray-500 duration-150"
                  fill="currentColor"
                  viewBox="0 0 48 48"
